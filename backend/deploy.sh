...
ENV_VARS+=",IMPLEMENTER_MODEL=${IMPLEMENTER_MODEL:-openai::gpt-5.1}"
ENV_VARS+=",VALIDATOR_MODEL=${VALIDATOR_MODEL:-gemini::gemini-3-pro-preview}"
ENV_VARS+=",PROFILE_MODEL=${PROFILE_MODEL:-gemini::gemini-3-pro-preview}"
ENV_VARS+=",POLISH_MODEL=${POLISH_MODEL:-gemini::gemini-3-pro-preview}"
ENV_VARS+=",INSIGHT_MODEL=${INSIGHT_MODEL:-meituan::longcat-flash-chat}"
