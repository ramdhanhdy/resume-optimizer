...
ENV_VARS+=",ANALYZER_MODEL=qwen/qwen3-max"
ENV_VARS+=",OPTIMIZER_MODEL=qwen/qwen3-max"
ENV_VARS+=",IMPLEMENTER_MODEL=qwen/qwen3-max"
ENV_VARS+=",VALIDATOR_MODEL=qwen/qwen3-max"
ENV_VARS+=",PROFILE_MODEL=qwen/qwen3-max"
ENV_VARS+=",POLISH_MODEL=zenmux::anthropic/claude-sonnet-4.5"
ENV_VARS+=",ANALYZER_TEMPERATURE=0.3"
ENV_VARS+=",OPTIMIZER_TEMPERATURE=0.7"
ENV_VARS+=",IMPLEMENTER_TEMPERATURE=0.1"
ENV_VARS+=",VALIDATOR_TEMPERATURE=0.2"
ENV_VARS+=",PROFILE_TEMPERATURE=0.1"
ENV_VARS+=",POLISH_TEMPERATURE=0.8"
